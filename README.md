...
Atualmente venho construindo projetos acadêmicos e pessoais utilizando tecnologias como **Python**, **Java**, **Spring Boot**, **JavaScript**, **TypeScript**, **React Native**, **Angular** e **PostgreSQL**.
...
- 🎓 Estudante de T.I
- 💻 Foco em desenvolvimento backend e aplicações completas
- 📱 Experiência inicial com desenvolvimento mobile usando React Native e Expo
- 🧠 Interesse em APIs, banco de dados, automação e análise de dados
- 🎮 Também gosto de games, tecnologia e arte digital
- 📚 Em constante aprendizado e evolução prática através de projetos
...
Além dos projetos principais, mantenho repositórios de estudo com exercícios e práticas em:
...
[![LinkedIn](https://img.shields.io/badge/LinkedIn-Ítalo_Rhide-0A66C2?style=for-the-badge&logo=linkedin&logoColor=white)](https://www.linkedin.com/in/%C3%ADtalo-rhide-furuya-ferreira-91a0a8245/)
